  ...
  return (
    <div className="relative flex flex-col justify-center items-center h-[70vh] border border-gray-200 bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-sm text-gray-500 font-aeonik-light mt-2 max-w-sm text-center">Infrastructure monitoring and resource management will be configured here.</p>
      </div>
    </div>
  )
}

    ...
    <div className="relative flex flex-col justify-center items-center h-[70vh] border border-gray-200 bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="h-16 w-16 border border-gray-200 flex items-center justify-center mb-6">
          <GitPullRequest className="h-6 w-6 text-gray-300" />
        </div>
        ...
        <p className="text-sm text-gray-500 font-aeonik-light mt-2 max-w-sm text-center">Pull request tracking and reviews will be available here.</p>
      </div>
    </div>
  )
}
